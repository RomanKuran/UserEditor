    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCreateUserLabel">{{ __('home.create') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body js-form-create-user js-form-fields">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary js-create-user">{{ __('home.create') }}</button>
            </div>
        </div>
    </div>
</div>
